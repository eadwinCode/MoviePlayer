...
namespace VirtualizingListView
{
    ...
    public class VideoItemViewCollection<T> : VirtualizingCollection<T>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        #region Constructors
        ...
        public VideoItemViewCollection(IItemsProvider<T> itemsProvider)
            : base(itemsProvider)
        {
        ...
        public VideoItemViewCollection(IItemsProvider<T> itemsProvider, int pageSize)
        ...
        public VideoItemViewCollection(IItemsProvider<T> itemsProvider, int pageSize, int pageTimeout)
