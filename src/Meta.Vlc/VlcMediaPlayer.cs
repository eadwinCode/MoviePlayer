...
namespace Meta.Vlc
{
    ...
    public class VlcMediaPlayer : IVlcObjectWithEvent
    {
        ...
        private readonly LibVlcEventCallBack _onMediaSubitemAdded;
        ...
        private GCHandle _onMediaSubitemAddedHandle;
        ...
        private VlcMediaPlayer(IVlcObject parentVlcObject, IntPtr pointer)
        {
            ...
            _onMediaSubitemAdded = OnSubItemChanged;
            ...
            _onMediaSubitemAddedHandle = GCHandle.Alloc(_onMediaSubitemAdded);
            ...
            EventManager.Attach(EventTypes.MediaSubItemAdded, _onMediaSubitemAdded, IntPtr.Zero);
        }
        ...
        public event EventHandler<ObjectEventArgs<MediaSubitemAddedArgs>> SubItemChanged;

        private void OnSubItemChanged(ref LibVlcEventArgs eventArgs, IntPtr userData)
        {
            if (SubItemChanged != null)
            {
                SubItemChanged(this,
                    new ObjectEventArgs<MediaSubitemAddedArgs>());
            }
        }
        ...
        public bool HasVideo { get { return IsMediaOpened; }}
        ...
        {
            get { return _getVideoAdjustIntFunction.Delegate(InstancePointer, VideoAdjust.Enable) == 1; }
        ...
        protected void Dispose(bool disposing)
        {
            ...
            EventManager.Detach(EventTypes.MediaSubItemAdded, _onMediaSubitemAdded, IntPtr.Zero);
            ...
            _onMediaSubitemAddedHandle.Free();
