...
namespace HTMLConverter
{
    ...
    public static class HtmlToXamlConverter
    {
        ...
        public static string ConvertHtmlToXaml(string htmlString, bool asFlowDocument)
        {
            ...
            string xaml = xamlFlowDocumentElement.OuterXml;//HtmlToXamlConverter.GetText(XamlReader.Parse(xamlFlowDocumentElement.OuterXml) as FlowDocument);
