...
{
    public class VirtualizingObservableCollection<T> : VirtualizingCollection<T>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="VideoItemViewCollection&lt;T&gt;"/> class.
        /// </summary>
        ...
        public VirtualizingObservableCollection(int pageSize)
            : base(pageSize)
        {
            _synchronizationContext = SynchronizationContext.Current;
        }
        ...
        public VirtualizingObservableCollection( int pageSize, int pageTimeout)
            : base(pageSize, pageTimeout)
        {
            _synchronizationContext = SynchronizationContext.Current;
        }
        ...
        protected override void VirtualizingCollection_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            base.VirtualizingCollection_CollectionChanged(sender, e);
        }
        ...
        private static IList<T> _currentview;
        /// <summary>
        ...
        private void LoadPageCompleted(object args)
        {
            ...
            //    this.PageIndexChangedEvent(page);
        ...
        internal static object GetCurrentViewItem()
        {
            return _currentview;
        }
    }
