...
{
    public  static partial class FileExplorerCommonHelper
    {
        ...
        private static void SelectWantedFiles( List<FileInfo> listfiles, FileInfo fileinfo, IDictionary<string, string> extensions)
        {
        ...
        public static List<DirectoryInfo> GetParentSubDirectory(DirectoryInfo DirectoryPosition, IDictionary<string, string> formats)
        {
        ...
        private static void SelectWantedDirectory(DirectoryInfo o,  List<DirectoryInfo> listDir, 
        ...
        public static List<DirectoryInfo> GetParentSubDirectoryWithoutCheck(DirectoryInfo DirectoryPosition,
        ...
        public static bool CheckForWantedDir(DirectoryInfo dir, IDictionary<string, string> formats)
        {
            string[] notsupported = { "etrg", "sample", "rarbg.com" };
            List<FileInfo> Listfiles = new List<FileInfo>();
            try
        ...
        public static ObservableCollection<SubtitleFilesModel> MatchSubToMedia(string p, IEnumerable<FileInfo> subpath)
        {
        ...
        public static IEnumerable<FileInfo> GetSubtitleFiles(DirectoryInfo dir)
        {
